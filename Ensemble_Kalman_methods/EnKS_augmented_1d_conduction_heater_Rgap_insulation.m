...
%% save figure
% figname1 = sprintf('./EnKS_v2/EnKS_augmented_v2_noise_%1.0E_Rnoise_%1.0E_sigmaq_%1.0E_rstep_%02d_dt_%1.1E_isensor_%d_fig1', sigma_noise, Rgap_noise, q_noise, r_step, dt, sensor_user_input(1));
